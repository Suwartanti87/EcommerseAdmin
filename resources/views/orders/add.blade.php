...
<div class="row">
  <div class="col-md-2">
    <a href="{{ url('/product/create') }}" class="btn btn-danger btn-block btn-sm"><i class="fas fa-plus"></i> &nbsp;Add</a>
  </div>
</div>
<br/>
      ...
      <tbody>
        ...
        <tr>  
          ...
          <td>
            ...
            <a href="{{route('transaksi.show', $row->id)}}"><i class="fas fa-cart-plus"></i></a>
          </td>
          </form>
          <td>
          ...
          <td>
            <a type="btn-sm" href="{{ route('product.edit', $row->id)}}" ><i class="far fa-edit"></i></a>
